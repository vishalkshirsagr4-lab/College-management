...
const StudentAdmin = lazy(() =>
  import("./pages/admin/StudentAdmin")
);

const SubjectsPage = lazy(() =>
  import("./pages/admin/SubjectsPage")
);
        ...
        <Route element={<AppLayout />}>
          ...
          <Route element={<RequireAuth role={ROLES.ADMIN} />}>
            ...
            <Route
              ...
              element={<Placeholder title="Assign Faculty" />}
            />
            ...
            <Route
              path="/admin/exams"
              element={<Placeholder title="Exams" />}
            />
          ...
          <Route element={<RequireAuth role={ROLES.FACULTY} />}>
            ...
            <Route
              ...
              element={<Placeholder title="My Subjects" />}
            />
            ...
            <Route
              path="/faculty/marks"
              element={<Placeholder title="Marks Entry" />}
            />

            <Route
              path="/faculty/exams-syllabus"
              element={<Placeholder title="Exams + Syllabus" />}
            />
          ...
          <Route element={<RequireAuth role={ROLES.STUDENT} />}>
            ...
            <Route
              path="/student/exams"
              element={<Placeholder title="Exams Schedule" />}
            />
